...
- **Grow when it hurts.** New sections, files, and rules need a demonstrated friction they resolve —
  "this would be nice" is not a rationale. The kit's value is its smallness; every addition is fighting
...
- **Experience reports** — you adopted the kit and something worked or failed. These are gold: they're
...
4. CI must pass (internal link integrity). A maintainer reviews with the kit's own reviewer stance:
